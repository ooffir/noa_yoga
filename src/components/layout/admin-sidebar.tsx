...
import { LayoutDashboard, Calendar, Users, LogOut, Home, UserCog, Newspaper, Settings, Sparkles, Wallet, BarChart3 } from "lucide-react";
...
const adminItems = [
  ...
  { href: "/admin/payments", icon: Wallet, label: "תשלומים" },
